...
def new_comment(instance, created, **kwargs):
    if created:
        ...
        send_mail(
            ...
            message=f'Здрваствуйте, {instance.message.author}, у Вашего сообщения, {instance.message.title}, есть новый комментарий, от {instance.author}. <a href="http://127.0.0.1:8000/messages/comments/{instance.id}">Прочитать</a>\n',
            from_email=None,
    ...
    if status:
        send_mail(
            ...
            message=f'Здравствуйте, {instance.author}!\n'
                    ...
                    f'http://127.0.0.1:8000/messages/{instance.message.id}',
            from_email=None,
